...
const RS_Content = () => {
   return (
      <div>
         ...
         <div className='px-2'>
            <button className='w-full p-2 bg-blue-600 text-white rounded my-1 flex items-center justify-center'><FaGoogle className='me-1' /> Login with Google</button>
            <button className='w-full p-2 bg-gray-700 text-white rounded my-1 flex items-center justify-center'><FaGithub className='me-1' /> Login with Github</button>
         </div>
