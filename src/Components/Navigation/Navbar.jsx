   ...
   return (
      <div className="navbar bg-slate-50 sticky top-0 border-b border-gray-400">
         ...
         <div className="navbar-end">
            ...
            <div>
               {user?.photoURL ? <img className="w-[35px] h-[35px] object-cover object-center rounded-full" src={user.photoURL} /> :
                  <img className="w-[35px] h-[35px] object-cover object-center rounded-full" src={UserProfile} />}
            </div>
